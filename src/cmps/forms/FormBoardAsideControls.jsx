...
export const FormBoardAsideControls = ({insertNewBoard, onEditBoard, board, onAddBoard, setControlsFormOpen, onRemoveBoard}) => {
    ...
    const onInsertNewBoard = (direction) => {
        setControlsFormOpen(false)
        insertNewBoard(direction, board)
    }
        ...
        <div className="form-board-aside-controls flex-col">
            ...
            <div className="row-group">
                <div className="form-row">
                    ...
                    <div className="text" onClick={removeBoard}>Delete</div>
                </div>
                ...
                <div className="form-row">
                    ...
                    <div className="text" onClick={()=>onInsertNewBoard('ABOVE')}>Create new Board above</div>
                </div>
                ...
                <div className="form-row">
                    ...
                    <div className="text" onClick={()=>onInsertNewBoard('BELOW')}>Create new Board below</div>
                </div>
