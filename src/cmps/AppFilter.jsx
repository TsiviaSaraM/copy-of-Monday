...
export const AppFilter = ({ handleFilterChange }) => {
    ...
    useOnClickOutside(ref, () => { setIsFilterExpanded(false) })
    ...
    return (
        // <div className="app-filter">
            ...
            <div className="search" ref={ref} onClick={() => { if (!isFilterExpanded) setIsFilterExpanded(true) }}>
                ...
                {isFilterExpanded ?
                    <div className="expanded-search-container flex">
                        ...
                        <input type="text" className="expanded-search" placeholder="Search" onChange={handleChange} />
